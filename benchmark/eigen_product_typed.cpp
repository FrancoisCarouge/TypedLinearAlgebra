...
void bench() {
  ...
  typed_matrix<double, n_tuple<double, N>, n_tuple<double, N>> a;
  typed_matrix<double, n_tuple<double, N>, n_tuple<double, N>> b;
...
//   std::ofstream results{"benchmark/matrix_product_mdspan.csv", std::ios::app};
  ...
  ankerl::nanobench::Bench()
      ...
      .name("eigen_product")
      .run([&]() { 
        typed_matrix<double, n_tuple<double, N>, n_tuple<double, N>> r = a * b;
