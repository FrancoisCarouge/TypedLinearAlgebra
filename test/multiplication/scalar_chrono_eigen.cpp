...
namespace {
//! @test Verifies the scalar multiplication operator with std::chrono
//! duration types of distinct periods.
[[maybe_unused]] const auto test{[] -> int {
  ...
  const row_vector<representation, seconds, minutes> a{seconds{1.},
                                                       minutes{2.}};
  const row_vector<representation, seconds, minutes> r{a * 3.};
