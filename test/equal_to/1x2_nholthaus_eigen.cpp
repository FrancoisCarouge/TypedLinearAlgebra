...
[[maybe_unused]] const auto test{[] -> int {
  ...
  const row_vector<representation, position, velocity> b{1. * m, 2. * mps};
  const row_vector<representation, position, velocity> c{1. * m, 3. * mps};
  const row_vector<representation, position, velocity> d{9. * m, 2. * mps};
