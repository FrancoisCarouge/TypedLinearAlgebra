...
namespace {
//! @test Verifies the dot operation rejects vectors whose heterogeneous
//! per-element types do not convert to a common product: a squared position
//! does not convert to a squared velocity.
[[maybe_unused]] const auto test{[] {
  ...
  [[maybe_unused]] const auto value{dot(a, b)};
