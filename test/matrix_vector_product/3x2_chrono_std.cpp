...
//! element column vector, with std::chrono element types.
[[maybe_unused]] const auto test{[] -> int {
  ...
  column_vector<representation, seconds, seconds, seconds> y{span_y};
  ...
  assert((y.at<0>() == seconds{3.}));
  assert((y.at<1>() == seconds{7.}));
  assert((y.at<2>() == seconds{11.}));
