...
//! @test Verifies the rank_typed_matrix concept over mp-units quantity indexes,
//! Eigen backend.
...
using plane = matrix<double, std::tuple<position, velocity>,
...
static_assert(rank_typed_matrix<const row &, 1>);
