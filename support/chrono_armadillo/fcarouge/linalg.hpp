...
//! @file
//! @brief Indexed-based linear algebra with std::chrono with Armadillo
//! implementations.
...
namespace fcarouge {
//! @brief Time quantity matrix with std::chrono and Armadillo implementations.
...
//! @brief Time quantity column vector with std::chrono and Armadillo
//! implementations.
...
//! @brief Time quantity row vector with std::chrono and Armadillo
//! implementations.
template <typename Representation, typename... Types>
using row_vector =
