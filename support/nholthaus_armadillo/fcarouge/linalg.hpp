...
//! @file
//! @brief Indexed-based linear algebra with nholthaus/units with Armadillo
//! implementations.
...
namespace fcarouge {
//! @brief Quantity matrix with nholthaus/units and Armadillo implementations.
...
//! @brief Quantity column vector with nholthaus/units and Armadillo
//! implementations.
...
//! @brief Quantity row vector with nholthaus/units and Armadillo
//! implementations.
template <typename Representation, typename... Types>
using row_vector =
