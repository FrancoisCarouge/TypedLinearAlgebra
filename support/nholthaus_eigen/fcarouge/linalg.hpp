...
//! @file
//! @brief Indexed-based linear algebra with nholthaus/units with Eigen
//! implementations.

#include "fcarouge/eigen.hpp"
#include "fcarouge/typed_linear_algebra.hpp"

#include "fcarouge/nholthaus.hpp"

#include <cstddef>
#include <tuple>

namespace fcarouge {
//! @brief Quantity matrix with nholthaus/units and Eigen implementations.
...
//! @brief Quantity column vector with nholthaus/units and Eigen
//! implementations.
...
//! @brief Quantity row vector with nholthaus/units and Eigen implementations.
template <typename Representation, typename... Types>
using row_vector =
