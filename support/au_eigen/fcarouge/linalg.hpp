...
//! @file
//! @brief Indexed-based linear algebra with Au with Eigen implementations.
...
namespace fcarouge {
//! @brief Quantity matrix with Au and Eigen implementations.
...
//! @brief Quantity column vector with Au and Eigen implementations.
template <typename Representation, typename... Types>
using column_vector =
    typed_column_vector<eigen::column_vector<Representation, sizeof...(Types)>,
                        Types...>;

//! @brief Quantity row vector with Au and Eigen implementations.
template <typename Representation, typename... Types>
using row_vector =
