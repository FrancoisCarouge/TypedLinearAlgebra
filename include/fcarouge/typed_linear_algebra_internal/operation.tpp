...
//!
//! @todo Should this be an internal tool? Should, can there be a safe public
//! version?
//!
...
operator/(const typed_matrix<Matrix1, RowIndexes1, ColumnIndexes1> &lhs,
  ...
  // TODO: Similar to multipication, needs verifications.
