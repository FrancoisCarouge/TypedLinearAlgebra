...
//! @file
//! @brief Time safe linear algebra with std::chrono and Armadillo.
//!
...
//! library composes Armadillo as the matrix' linear algebra backend with
//! indexes typed as `std::chrono` durations. This sample explicitly uses double
